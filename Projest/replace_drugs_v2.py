...
refrigerated_drugs = [
    ...
    "Infliximab",
    "Ipilimumab",
    "Irinotecan (แบบ Liposomal)",
    "Mitoxantrone",
    "Nivolumab",
    "Panitumumab",
    "Pembrolizumab",
    "Pemetrexed (บางยี่ห้อ)",
    "Phesgo",
    "Rescuvorin (Leucovorin)",
    "Rituximab",
    "Romiplostim",
    "Trastuzumab",
...
all_drugs = room_temp_drugs + refrigerated_drugs

def generate_manage_rows():
    rows = []
    for i, name in enumerate(all_drugs, 1):
        code = f"PD-{i:05d}"
...
print(f"Medication lists updated. Total drugs: {len(all_drugs)}")
